...
export function createInitialShelgunta(userConfig: UserConfig): Shelgunta {
  return {
    currentScene: "TITLE",
    scenes: {
      title: createInitialTitleScene(userConfig),
      game: createInitialGameScene(userConfig),
      clear: createInitialClearScene(userConfig),
      gameOver: createInitialGameOverScene(userConfig),
    },
  }
}
